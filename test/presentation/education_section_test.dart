...
void main() {
  testWidgets(
    'EducationSection displays all items and icons from educationList',
    (WidgetTester tester) async {
      // Render the widget
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: SingleChildScrollView(child: EducationSection()),
          ),
        ),
      );
  ...
  testWidgets('EduTile renders correctly with isolated synthetic data', (
    WidgetTester tester,
  ) async {
