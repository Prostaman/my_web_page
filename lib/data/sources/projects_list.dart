...
const List<ProjectEntity> projectsList = [
  ProjectEntity(
    ...
    androidUrl: 'https://play.google.com/store/apps/details?id=de.b2.verben.trio',
  ...
  ProjectEntity(
    ...
    androidUrl: 'https://play.google.com/store/apps/details?id=com.metal_detectorist.trio_r',
  ),
